...
class ParkingDetailFilter(filters.FilterSet):
    parking_wing_id = filters.NumberFilter(field_name='parking_wing__id', lookup_expr='exact')
    parking_wing_name = filters.CharFilter(field_name='parking_wing__wing_name', lookup_expr='exact')
